    ...
    public partial class FormHome : Form
    {
        ...
        private void buttonPayNow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sqlCommand = new MySqlCommand(sqlQuery, sqlConnect);
                sqlAdapter = new MySqlDataAdapter(sqlCommand);
                bunifuPageHome.SelectTab(tabPageOrderInvoice);
                ...
                ////CrystalReportInvoice cobaReport = new CrystalReportInvoice();
                ////cobaReport.Load(@"C:\Users\ASUS\Downloads\WATCHOUT_DESKTOP(5Juni)\WATCHOUT_DESKTOP(2JUNI)\WATCHOUT_DESKTOP(28mei)\WATCHOUT_DESKTOP(1)\WATCHOUT_DESKTOP\WATCHOUT_DESKTOP\CrystalReportInvoice.rpt");
                ////cobaReport.SetParameterValue("IDBeli", );
                ////FormInvoice formInvoice = new FormInvoice();
                ////formInvoice.Show();


                //bunifuLabelIDBELI.Text = IDBeli;
                ////CODE REPORTS

                //CrystalReportInvoice cobaReport = new CrystalReportInvoice();
                //cobaReport.Load(@"C:\Users\ASUS\Downloads\WATCHOUT_DESKTOP(5Juni)\WATCHOUT_DESKTOP(2JUNI)\WATCHOUT_DESKTOP(28mei)\WATCHOUT_DESKTOP(1)\WATCHOUT_DESKTOP\WATCHOUT_DESKTOP\CrystalReportInvoice.rpt");
                //cobaReport.SetParameterValue("IDBeli", bunifuLabelIDBELI.Text);
                //FormInvoice formInvoice = new FormInvoice();
                //formInvoice.Show();

                ////string cobabaru = bunifuLabelIDBELI.Text;
                ////CrystalReportInvoice
                ////CrystalReportInvoice.SetParameterValue("IDBeli", bunifuLabelIDBELI.Text);
